...
Rails.application.config.sorcery.configure do |config|
  ...
  #
#   config.twitter.key = "WRvFcSbWJJgNn7pO7jAkNx3OK"
#   config.twitter.secret = "d76ngXfCuBcW5Z3auVRloMwf8uI0x9Z7C3MB629dmTFfJlzIMx"
#   config.twitter.callback_url = "https://arcane-reef-3552.herokuapp.com/oauth/callback?provider=twitter"
#   config.twitter.user_info_mapping = {:email => "screen_name"}
  #
#   config.facebook.key = "1409526589352118"
#   config.facebook.secret = "5cefbfeb54395745a73e4cfd0f279240"
#   config.facebook.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=facebook"
#   config.facebook.user_info_mapping = {:username => "email"}
...
#   config.facebook.display = "popup"
  #
    ...
    config.github.scope = "emails"
#    config.github.access_permissions = ["email"]
